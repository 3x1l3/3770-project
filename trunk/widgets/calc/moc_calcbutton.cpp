...
const QMetaObject CalcButton::staticMetaObject = {
    { &QPushButton::staticMetaObject, qt_meta_stringdata_CalcButton,
      qt_meta_data_CalcButton, 0 }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &CalcButton::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_CalcButton))
        return static_cast<void*>(const_cast< CalcButton*>(this));
...
// SIGNAL 0
void CalcButton::buttonText(QString _t1)
{
